...
HanzoBot is the AI that actually does things.
...
HanzoBot started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> HanzoBot.
...
Security in HanzoBot is a deliberate tradeoff: strong defaults without killing capability.
...
HanzoBot has an extensive plugin API.
...
HanzoBot is currently terminal-first by design.
...
HanzoBot is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep HanzoBot hackable by default.
