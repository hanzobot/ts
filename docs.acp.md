...
This document describes how the HanzoBot ACP (Agent Client Protocol) bridge works,
...
HanzoBot Gateway over WebSocket. It keeps ACP session ids mapped to Gateway
...
drive a HanzoBot Gateway session.
