  ...
  if (typeof window === "undefined") {
    vi.stubGlobal(
      ...
      value == null
        ...
        : ({ __BOT_CONTROL_UI_BASE_PATH__: value } as Window & typeof globalThis),
    );
    return;
  }
  if (value == null) {
    delete window.__BOT_CONTROL_UI_BASE_PATH__;
    return;
  }
  Object.defineProperty(window, "__BOT_CONTROL_UI_BASE_PATH__", {
    value,
    writable: true,
    configurable: true,
  });
