...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    marketplace: "Compartilhar e descobrir capacidade de computação IA.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando hanzo-bot dashboard --no-open no desktop.",
    },
    insecure: {
