...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    marketplace: "KI-Rechenkapazität teilen und entdecken.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von hanzo-bot dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
