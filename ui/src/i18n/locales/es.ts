...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    marketplace: "Compartir y descubrir capacidad de cómputo IA.",
    config: "Editar ~/.hanzoai/bot.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde hanzo-bot dashboard --no-open en tu escritorio.",
    },
    insecure: {
