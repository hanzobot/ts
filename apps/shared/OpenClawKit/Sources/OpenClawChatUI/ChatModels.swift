...
public typealias Hanzo BotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias Hanzo BotPlatformImage = UIImage
#endif

public struct Hanzo BotChatUsageCost: Codable, Hashable, Sendable {
...
public struct Hanzo BotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: Hanzo BotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(Hanzo BotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct Hanzo BotChatMessageContent: Codable, Hashable, Sendable {
...
public struct Hanzo BotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [Hanzo BotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: Hanzo BotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [Hanzo BotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: Hanzo BotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(Hanzo BotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([Hanzo BotChatMessageContent].self, forKey: .content) {
...
public struct Hanzo BotChatHistoryPayload: Codable, Sendable {
...
public struct Hanzo BotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct Hanzo BotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [Hanzo BotSessionPreviewItem]
}

public struct Hanzo BotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [Hanzo BotSessionPreviewEntry]

    public init(ts: Int, previews: [Hanzo BotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct Hanzo BotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct Hanzo BotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct Hanzo BotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct Hanzo BotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct Hanzo BotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct Hanzo BotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: Hanzo BotPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: Hanzo BotPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct Hanzo BotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
