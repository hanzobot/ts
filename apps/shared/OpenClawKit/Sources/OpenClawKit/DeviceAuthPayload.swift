...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: Hanzo BotProtocol.AnyCodable]?
    {
        ...
        return [
            "id": Hanzo BotProtocol.AnyCodable(identity.deviceId),
            "publicKey": Hanzo BotProtocol.AnyCodable(publicKey),
            "signature": Hanzo BotProtocol.AnyCodable(signature),
            "signedAt": Hanzo BotProtocol.AnyCodable(signedAtMs),
            "nonce": Hanzo BotProtocol.AnyCodable(nonce),
        ]
    }
}
