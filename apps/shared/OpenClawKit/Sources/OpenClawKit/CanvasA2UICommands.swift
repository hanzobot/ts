...
public enum Hanzo BotCanvasA2UICommand: String, Codable, Sendable {
...
public struct Hanzo BotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct Hanzo BotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
