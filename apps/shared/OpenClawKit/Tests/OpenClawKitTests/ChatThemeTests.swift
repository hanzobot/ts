...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = Hanzo BotChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = Hanzo BotChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
