...
import ai.hanzo.bot.app.ui.mobileAccentBorderStrong
...
import ai.hanzo.bot.app.ui.mobileSurface
import ai.hanzo.bot.app.ui.mobileText
import ai.hanzo.bot.app.ui.mobileTextSecondary
import ai.hanzo.bot.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.hanzo.bot.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.hanzo.bot.app.ui.mobileFontFamily,
