...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.hanzo.bot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".hanzo-bot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.botCommand(
            subcommand: "gateway",
