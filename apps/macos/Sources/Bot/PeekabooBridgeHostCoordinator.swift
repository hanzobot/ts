...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "ai.hanzo.bot", category: "PeekabooBridge")
    ...
    private static var botSocketPath: String {
        ...
        let directory = base.appendingPathComponent("HanzoBot", isDirectory: true)
    ...
    private func startIfNeeded() async {
        ...
        let services = HanzoBotPeekabooBridgeServices()
...
@MainActor
private final class HanzoBotPeekabooBridgeServices: PeekabooBridgeServiceProviding {
