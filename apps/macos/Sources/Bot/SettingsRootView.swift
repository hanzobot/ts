...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .botSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? BotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? BotPaths.stateDirURL.path
...
extension Notification.Name {
    static let botSelectSettingsTab = Notification.Name("botSelectSettingsTab")
}
