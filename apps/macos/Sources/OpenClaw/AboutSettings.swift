...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/hanzoai/bot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/hanzoai/bot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://hanzo.bot")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "Hanzo BotBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "Hanzo BotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "Hanzo BotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "Hanzo BotGitCommit") as? String) ??
            "unknown"
    }
