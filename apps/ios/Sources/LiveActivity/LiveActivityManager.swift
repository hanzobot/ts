...
final class LiveActivityManager {
    ...
    private var currentActivity: Activity<HanzoBotActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = HanzoBotActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<HanzoBotActivityAttributes>.activities
    ...
    private func updateCurrent(state: HanzoBotActivityAttributes.ContentState) {
    ...
    private func connectingState() -> HanzoBotActivityAttributes.ContentState {
        HanzoBotActivityAttributes.ContentState(
    ...
    private func idleState() -> HanzoBotActivityAttributes.ContentState {
        HanzoBotActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> HanzoBotActivityAttributes.ContentState {
        HanzoBotActivityAttributes.ContentState(
