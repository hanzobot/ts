...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = Hanzo BotLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = Hanzo BotLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.hanzo.bot.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Hanzo Bot agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Hanzo Bot agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while Hanzo Bot is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Hanzo Bot. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(Hanzo BotLocationMode.off.rawValue)
                            Text("While Using").tag(Hanzo BotLocationMode.whileUsing.rawValue)
                            Text("Always").tag(Hanzo BotLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Hanzo Bot is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Hanzo Bot", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = Hanzo BotLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Hanzo Bot chat and run /pair approve, then tap Connect again."
        }
