...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: Hanzo BotPhotosLatestParams) async throws -> Hanzo BotPhotosLatestPayload {
        ...
        var results: [Hanzo BotPhotoPayload] = []
        ...
        return Hanzo BotPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> Hanzo BotPhotoPayload
    {
