...
```bash
ASC_APP_IDENTIFIER=ai.hanzo.bot.client
# or
...
- The beta flow regenerates `apps/ios/Hanzo Bot.xcodeproj` from `apps/ios/project.yml` before archiving
