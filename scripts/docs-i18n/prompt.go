...
- Keep product names in English: HanzoBot, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the HanzoBot Gateway, use “Gateway 网关”.
