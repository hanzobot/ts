...
const (
	envDocsPiExecutable     = "BOT_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "BOT_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "BOT_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "@hanzo/bot", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
