...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "@hanzo/bot", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Hanzo Bot. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Hanzo Bot Issue Label Audit");
