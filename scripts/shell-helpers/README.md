...
Inspired by Simon Willison's [Running Hanzo Bot in Docker](https://til.simonwillison.net/llms/openclaw-docker).
...
| `clawdock-cli <command>`  | Run Hanzo Bot CLI commands                      |
...
| `clawdock-cd`        | Jump to the Hanzo Bot project directory    |
| `clawdock-config`    | Open the Hanzo Bot config directory        |
