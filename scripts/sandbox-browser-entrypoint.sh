...
CDP_PORT="${BOT_BROWSER_CDP_PORT:-${BOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${BOT_BROWSER_CDP_SOURCE_RANGE:-${BOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${BOT_BROWSER_VNC_PORT:-${BOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${BOT_BROWSER_NOVNC_PORT:-${BOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${BOT_BROWSER_ENABLE_NOVNC:-${BOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${BOT_BROWSER_HEADLESS:-${BOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${BOT_BROWSER_NO_SANDBOX:-${BOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${BOT_BROWSER_NOVNC_PASSWORD:-${BOT_BROWSER_NOVNC_PASSWORD:-}}"
