...
# Output:
# - dist/Hanzo Bot.app
# - dist/Hanzo Bot-<version>.zip
# - dist/Hanzo Bot-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.hanzo.bot.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Hanzo Bot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Hanzo Bot-$VERSION.zip"
DMG="$ROOT_DIR/dist/Hanzo Bot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Hanzo Bot-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Hanzo Bot-$VERSION.dSYM.zip"
