...
# Output:
# - dist/HanzoBot.app
# - dist/HanzoBot-<version>.zip
# - dist/HanzoBot-<version>.dmg
...
APP="$ROOT_DIR/dist/HanzoBot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/HanzoBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/HanzoBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/HanzoBot-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/HanzoBot-$VERSION.dSYM.zip"
