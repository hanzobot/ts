...
- BOT_GATEWAY_VERSION = exact package.json version
- BOT_MARKETING_VERSION = short iOS/App Store version
- BOT_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
BOT_GATEWAY_VERSION = ${PACKAGE_VERSION}
BOT_MARKETING_VERSION = ${MARKETING_VERSION}
BOT_BUILD_VERSION = ${BUILD_NUMBER}
EOF
