...
if [[ -z "$version_content" ]]; then
  echo "<h2>HanzoBot $VERSION</h2>"
  echo "<p>Latest HanzoBot update.</p>"
  echo "<p><a href=\"https://github.com/hanzo-bot/hanzo-bot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
