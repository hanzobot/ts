...
APP_BUNDLE="${1:-dist/Hanzo Bot.app}"
...
# Sign main binary
if [ -f "$APP_BUNDLE/Contents/MacOS/Hanzo Bot" ]; then
  echo "Signing main binary"; sign_item "$APP_BUNDLE/Contents/MacOS/Hanzo Bot" "$APP_ENTITLEMENTS"
fi
