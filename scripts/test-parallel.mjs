...
const unitIsolatedFilesRaw = [
  ...
  "src/agents/bot-tools.subagents.sessions-spawn.lifecycle.test.ts",
...
// BOT_TEST_VM_FORKS=0, and let users force-enable with =1.
...
const silentArgs = process.env.BOT_TEST_SHOW_PASSED_LOGS === "1" ? [] : ["--silent=passed-only"];
