...
export async function finalizeSetupWizard(
    ...
    if (webSearchEnabled !== false && hasKey) {
      ...
      await prompter.note(
        [
          ...
          `  ${formatCliCommand("hanzo-bot configure --section web")}`,
          "",
          `Get your key at: ${entry?.signupUrl ?? "https://docs.hanzo.bot/tools/web"}`,
          "Docs: https://docs.hanzo.bot/tools/web",
        ].join("\n"),
        "Web search",
      );
      ...
      await prompter.note(
        [
          ...
          `Re-enable: ${formatCliCommand("hanzo-bot configure --section web")}`,
          "",
          "Docs: https://docs.hanzo.bot/tools/web",
        ].join("\n"),
        "Web search",
  ...
  await prompter.note(
    'What now: https://hanzo.bot/showcase ("What People Are Building").',
    "What now",
  );
