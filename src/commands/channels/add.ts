...
import { writeConfigFile, type HanzoBotConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: HanzoBotConfig | null) {
...
export async function channelsAddCommand(
  ...
  // May trigger loadHanzoBotPlugins on cache miss (disk scan + jiti import)
