...
describe("isGatewayArgv", () => {
  ...
  it("matches known entrypoints across slash and case variants", () => {
    expect(isGatewayArgv(["NODE", "C:\\Hanzo Bot\\DIST\\ENTRY.JS", "gateway"])).toBe(true);
  ...
  it("matches the hanzo-bot executable but gates the gateway binary behind the opt-in flag", () => {
