...
function resolveAvatarSource(cfg: HanzoBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: HanzoBotConfig, agentId: string): AgentAvatarResolution {
