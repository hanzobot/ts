...
const FAST_TEST_MODE = process.env.BOT_TEST_FAST === "1";
    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            '`agents_list` and `subagents` apply to Hanzo Bot sub-agents (`runtime: "subagent"`); ACP harness ids are controlled by `acp.allowedAgents`.',
            ...
            'Use `subagents` only for Hanzo Bot subagents (`runtime: "subagent"`).',
