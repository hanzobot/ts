...
function resolveWatchPaths(workspaceDir: string, config?: HanzoBotConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: HanzoBotConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: HanzoBotConfig }) {
