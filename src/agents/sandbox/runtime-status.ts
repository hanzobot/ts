...
function resolveMainSessionKeyForSandbox(params: { cfg?: BotConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: BotConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
