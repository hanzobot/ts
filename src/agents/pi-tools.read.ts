...
function resolveAdaptiveReadMaxBytes(options?: Hanzo BotReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createHanzo BotReadTool(base, {
...
export function createHanzo BotReadTool(
  base: AnyAgentTool,
  options?: Hanzo BotReadToolOptions,
): AnyAgentTool {
