...
function resolvePostCompactionIndexSyncMode(config?: Hanzo BotConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureHanzo BotModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createHanzo BotCodingTools({
      exec: {
