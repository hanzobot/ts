...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<HanzoBotConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<HanzoBotConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: HanzoBotConfig): WebSearchConfig {
