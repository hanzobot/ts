...
export function resolveSubagentToolPolicy(cfg?: Hanzo BotConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: Hanzo BotConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: Hanzo BotConfig["tools"];
