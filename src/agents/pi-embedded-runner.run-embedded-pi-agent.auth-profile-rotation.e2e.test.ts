...
const makeConfig = (opts?: { fallbacks?: string[]; apiKey?: string }): BotConfig =>
  ({
    agents: {
      defaults: {
        model: {
...
const makeAgentOverrideOnlyFallbackConfig = (agentId: string): BotConfig =>
  ({
    agents: {
      defaults: {
        model: {
...
const makeCopilotConfig = (): BotConfig =>
  ({
    models: {
      providers: {
        "github-copilot": {
