...
homepage: https://docs.hanzo-bot.ai/automation/hooks#command-logger
metadata:
  {
    "hanzo-bot":
      {
        "emoji": "📝",
        "events": ["command"],
        "install": [{ "id": "bundled", "kind": "bundled", "label": "Bundled with HanzoBot" }],
      },
  }
---
...
2. **Use logrotate** (Linux):
   Create `/etc/logrotate.d/hanzo-bot`:
   ```
   /home/username/.hanzo-bot/logs/commands.log {
       weekly
       rotate 4
       compress
       missingok
