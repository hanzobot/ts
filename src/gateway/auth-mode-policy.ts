...
export function hasAmbiguousGatewayAuthModeConfig(cfg: Hanzo BotConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: Hanzo BotConfig): void {
