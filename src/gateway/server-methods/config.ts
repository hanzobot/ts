...
import type { ConfigValidationIssue, HanzoBotConfig } from "../../config/types.openclaw.js";
import {
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: HanzoBotConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, both loadConfig() and loadHanzoBotPlugins() already cache
