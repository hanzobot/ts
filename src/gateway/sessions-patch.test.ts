...
const EMPTY_CFG = {} as Hanzo BotConfig;
...
async function applySubagentModelPatch(cfg: Hanzo BotConfig) {
...
function createAllowlistedAnthropicModelCfg(): Hanzo BotConfig {
  return {
    agents: {
      defaults: {
