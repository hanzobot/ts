...
export function collectConfiguredModelPricingRefs(config: HanzoBotConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: HanzoBotConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
