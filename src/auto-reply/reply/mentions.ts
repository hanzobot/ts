...
function resolveMentionPatterns(cfg: Hanzo BotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: Hanzo BotConfig | undefined, agentId?: string): RegExp[] {
