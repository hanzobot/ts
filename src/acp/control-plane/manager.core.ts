...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: HanzoBotConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: HanzoBotConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: HanzoBotConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: HanzoBotConfig }): Promise<void> {
