...
export function listAuthProfileStorePaths(config: HanzoBotConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: HanzoBotConfig, stateDir: string): string[] {
