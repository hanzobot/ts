    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["hanzo-bot memory status", "Show index and provider status."],
          ["hanzo-bot memory status --deep", "Probe embedding provider readiness."],
          ["hanzo-bot memory index --force", "Force a full reindex."],
          ['openclaw memory search "meeting notes"', "Quick search using positional query."],
          [
            'openclaw memory search --query "deployment" --max-results 20',
            "Limit results for focused troubleshooting.",
          ],
          ["hanzo-bot memory status --json", "Output machine-readable JSON (good for scripts)."],
