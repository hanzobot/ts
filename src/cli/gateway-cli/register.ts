      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["hanzo-bot gateway run", "Run the gateway in the foreground."],
            ["hanzo-bot gateway status", "Show service status and probe reachability."],
            ["hanzo-bot gateway discover", "Find local and wide-area gateway beacons."],
            ["hanzo-bot gateway call health", "Call a gateway RPC method directly."],
