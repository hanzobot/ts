...
function buildHooksReport(config: HanzoBotConfig): HookStatusReport {
...
function enableInternalHookEntries(config: HanzoBotConfig, hookNames: string[]): HanzoBotConfig {
