...
export function applyGoogleGeminiModelDefault(cfg: HanzoBotConfig): {
  next: HanzoBotConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: HanzoBotConfig): HanzoBotConfig {
...
export function applyOpenAIConfig(cfg: HanzoBotConfig): HanzoBotConfig {
...
export function applyOpencodeGoModelDefault(cfg: HanzoBotConfig): {
  next: HanzoBotConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: HanzoBotConfig): {
  next: HanzoBotConfig;
  changed: boolean;
} {
