...
export function resolveTtsConfig(cfg: HanzoBotConfig): ResolvedTtsConfig {
...
export function buildTtsSystemPromptHint(cfg: HanzoBotConfig): string | undefined {
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: HanzoBotConfig): TtsProvider[] {
