...
const buildMissingEntryErrorMessage = async () => {
  ...
  lines.push(
    "For pinned GitHub installs, use `npm install -g github:hanzoai/bot#<ref>` instead of a raw `/archive/<ref>.tar.gz` URL.",
  );
  lines.push("For releases, use `npm install -g @hanzo/bot@latest`.");
  return lines.join("\n");
};
