...
Nostr DM channel plugin for Hanzo Bot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Hanzo Bot. It enables your bot to:
...
# Configure hanzo-bot to use local relay
