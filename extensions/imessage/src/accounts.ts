...
function mergeIMessageAccountConfig(cfg: HanzoBotConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: HanzoBotConfig): ResolvedIMessageAccount[] {
