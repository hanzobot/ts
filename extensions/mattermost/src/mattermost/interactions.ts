...
import { isTrustedProxyAddress, resolveClientIp, type HanzoBotConfig } from "../runtime-api.js";
...
type InteractionCallbackConfig = Pick<HanzoBotConfig, "gateway" | "channels"> & {
  interactions?: {
