# Google Gemini CLI Auth (Hanzo Bot plugin)
...
```bash
hanzo-bot plugins enable google-gemini-cli-auth
```
...
```bash
hanzo-bot models auth login --provider google-gemini-cli --set-default
```
