...
import { resolvePreferredHanzoBotTmpDir } from "openclaw/plugin-sdk/infra-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: HanzoBotConfig; override?: TtsConfig }): {
  cfg: HanzoBotConfig;
