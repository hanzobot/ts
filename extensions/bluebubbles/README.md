...
This directory contains the **BlueBubbles external channel plugin** for Hanzo Bot.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `hanzo-bot/plugin-sdk` helpers.
