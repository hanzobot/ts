...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): Hanzo BotConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: Hanzo BotConfig): TelegramAccountConfig => {
    try {
