...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.hanzo-bot/hanzo-bot.json`
...
- The script prints a `MEDIA:` line for HanzoBot to auto-attach on supported chat providers.
