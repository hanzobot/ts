...
read_when:
  ...
  - Wiring external systems into Hanzo Bot
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Hanzo Bot config directory (typically `~/.hanzo/bot/hooks/transforms`).
