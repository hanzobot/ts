---
summary: "macOS IPC architecture for Hanzo Bot app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# Hanzo Bot macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → Hanzo Bot.app → local execution.
