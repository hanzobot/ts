...
- Same path: run the app from a fixed location (for HanzoBot, `dist/HanzoBot.app`).
...
Workaround: move files into the HanzoBot workspace (`~/.hanzo-bot/workspace`) if you want to avoid per-folder grants.
