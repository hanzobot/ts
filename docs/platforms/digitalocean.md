---
summary: "HanzoBot on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up HanzoBot on DigitalOcean
  - Looking for cheap VPS hosting for HanzoBot
title: "DigitalOcean"
---

# HanzoBot on DigitalOcean

## Goal

Run a persistent HanzoBot Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
# Check service
systemctl --user status hanzo-bot-gateway.service

# View logs
journalctl --user -u hanzo-bot-gateway.service -f
```
