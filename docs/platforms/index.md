...
HanzoBot core is written in TypeScript. **Node is the recommended runtime**.
...
- macOS: LaunchAgent (`ai.hanzo.bot.gateway` or `ai.hanzo.bot.<profile>`; legacy `com.hanzo-bot.*`)
- Linux/WSL2: systemd user service (`hanzo-bot-gateway[-<profile>].service`)
