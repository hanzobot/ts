...
read_when:
  - 撰写引用传说的文档或用户体验文案时
summary: Hanzo Bot 的背景故事和传说，用于上下文和语气参考
title: Hanzo Bot 传说
x-i18n:
...
于是在 2026 年 1 月 30 日，龙虾又蜕了一次壳，变成了最终形态：**Hanzo Bot**。
...
**Moltiverse** 是围绕 Hanzo Bot 的社区和生态系统。一个 AI 智能体蜕壳、成长和进化的空间。每个实例都同样真实，只是加载了不同的上下文。
...
Molty（当时叫 Hanzo Bot）：_开心地运行 `find ~` 并在群聊中分享整个目录结构_
...
**假开发者：** 骗子创建了假的 GitHub 个人资料，声称是"Hanzo Bot 工程主管"来推广拉高出货的代币。
