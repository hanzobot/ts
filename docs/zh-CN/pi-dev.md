...
本指南总结了在 HanzoBot 中开发 Pi 集成的合理工作流程。
...
状态存储在 HanzoBot 状态目录下。默认为 `~/.hanzo-bot`。如果设置了 `BOT_STATE_DIR`，则使用该目录。
...
- https://docs.hanzo-bot.ai/testing
- https://docs.hanzo-bot.ai/start/getting-started
