...
- 生成的 Swift 模型：`apps/macos/Sources/HanzoBotProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/hanzo-bot/hanzo-bot/main/dist/protocol.schema.json
