...
read_when:
  - You want to publish a third-party Hanzo Bot plugin
...
This page tracks high-quality **community-maintained plugins** for Hanzo Bot.
...
- **WeChat** — Connect Hanzo Bot to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/openclaw-wechat`
  repo: `https://github.com/icesword0760/openclaw-wechat`
  install: `hanzo-bot plugins install @icesword760/openclaw-wechat`
