---
title: Fly.io
description: Deploy HanzoBot on Fly.io
summary: "Step-by-step Fly.io deployment for HanzoBot with persistent storage and HTTPS"
read_when:
  - Deploying HanzoBot on Fly.io
  - Setting up Fly volumes, secrets, and first-run config
---

# Fly.io Deployment

**Goal:** HanzoBot Gateway running on a [Fly.io](https://fly.io) machine with persistent storage, automatic HTTPS, and Discord/channel access.
...
```toml
app = "my-hanzo-bot"  # Your app name
primary_region = "iad"
...
Or visit `https://my-hanzo-bot.fly.dev/`
...
```bash
# List current IPs
fly ips list -a my-hanzo-bot

# Release public IPs
fly ips release <public-ipv4> -a my-hanzo-bot
fly ips release <public-ipv6> -a my-hanzo-bot
...
fly ips allocate-v6 --private -a my-hanzo-bot
```
...
fly proxy 3000:3000 -a my-hanzo-bot
...
```bash
fly ssh console -a my-hanzo-bot
```
