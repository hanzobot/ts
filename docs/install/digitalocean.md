---
summary: "Host Hanzo Bot on a DigitalOcean Droplet"
read_when:
  - Setting up Hanzo Bot on DigitalOcean
  - Looking for a simple paid VPS for Hanzo Bot
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Hanzo Bot Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `hanzo-bot doctor --non-interactive` and check logs with `journalctl --user -u openclaw-gateway.service -n 50`.
