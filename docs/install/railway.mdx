...
Deploy HanzoBot on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/hanzo-bot` — Control UI
...
- `BOT_STATE_DIR=/data/.hanzo-bot` (recommended)
...
This exports your HanzoBot state + workspace so you can migrate to another host without losing config or memory.
