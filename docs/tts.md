...
Hanzo Bot can convert outbound replies into audio using ElevenLabs, Microsoft, or OpenAI.
...
Hanzo Bot defaults to Microsoft (unless disabled via
...
- **Microsoft**: uses `microsoft.outputFormat` (default `audio-24khz-48kbitrate-mono-mp3`).
  ...
  - If the configured Microsoft output format fails, Hanzo Bot retries with MP3.
