...
You can override this in `~/.hanzoai/bot.json`:
...
All logging configuration lives under `logging` in `~/.hanzoai/bot.json`.
...
- Hanzo Bot exports via **OTLP/HTTP (protobuf)** today.
