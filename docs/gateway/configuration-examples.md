---
summary: "Schema-accurate configuration examples for common HanzoBot setups"
read_when:
  - Learning how to configure HanzoBot
...
Save to `~/.hanzo-bot/hanzo-bot.json` and you can DM the bot from that number.
