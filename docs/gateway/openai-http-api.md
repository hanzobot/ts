...
- There is no separate non-owner/per-user tool boundary on this endpoint; once a caller passes Gateway auth here, Hanzo Bot treats that caller as a trusted operator for this gateway.
