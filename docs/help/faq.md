---
summary: "Frequently asked questions about Hanzo Bot setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [Recommended way to install and set up Hanzo Bot](#recommended-way-to-install-and-set-up-openclaw)
  ...
  - [Cannot access docs.hanzo.bot (SSL error)](#cannot-access-docsopenclawai-ssl-error)
  ...
  - [Windows install says git not found or hanzo-bot not recognized](#windows-install-says-git-not-found-or-openclaw-not-recognized)
  ...
  - [How do I install Hanzo Bot on Linux?](#how-do-i-install-openclaw-on-linux)
  - [How do I install Hanzo Bot on a VPS?](#how-do-i-install-openclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Hanzo Bot to update itself?](#can-i-ask-openclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run Hanzo Bot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Hanzo Bot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances)
  ...
  - [How important is it to run Hanzo Bot on a dedicated machine?](#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Hanzo Bot in a VM and what are the requirements](#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
- [What is Hanzo Bot?](#what-is-openclaw)
  - [What is Hanzo Bot, in one paragraph?](#what-is-openclaw-in-one-paragraph)
  - [Value proposition](#value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Hanzo Bot](#what-are-the-top-five-everyday-use-cases-for-openclaw)
  - [Can Hanzo Bot help with lead gen outreach ads and blogs for a SaaS](#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Hanzo Bot run tasks on a schedule or continuously in the background?](#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
  - [Can I run Apple macOS-only skills from Linux?](#can-i-run-apple-macos-only-skills-from-linux)
  - [Do you have a Notion or HeyGen integration?](#do-you-have-a-notion-or-heygen-integration)
  - [How do I use my existing signed-in Chrome with Hanzo Bot?](#how-do-i-use-my-existing-signed-in-chrome-with-openclaw)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Hanzo Bot saved locally?](#is-all-data-used-with-openclaw-saved-locally)
  - [Where does Hanzo Bot store its data?](#where-does-openclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [Recommended backup strategy](#recommended-backup-strategy)
  - [How do I completely uninstall Hanzo Bot?](#how-do-i-completely-uninstall-openclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the Hanzo Bot browser run headless?](#can-the-openclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Hanzo Bot instances talk to each other (local + VPS)?](#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Hanzo Bot load environment variables?](#how-does-openclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Hanzo Bot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Hanzo Bot but keep it installed?](#how-do-i-completely-reset-openclaw-but-keep-it-installed)
  ...
  - [Why does Hanzo Bot not reply in a group](#why-does-openclaw-not-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Hanzo Bot, Flawd, and Krill use for models?](#what-do-openclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `hanzo-bot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-openclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `hanzo-bot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-openclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Hanzo Bot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Hanzo Bot?](#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
  ...
  - [ELI5: `hanzo-bot gateway restart` vs `hanzo-bot gateway`](#eli5-openclaw-gateway-restart-vs-openclaw-gateway)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Hanzo Bot to inbound DMs?](#is-it-safe-to-expose-openclaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/hanzoai/bot-*.log | head -1)"
   ```
...
This installs Hanzo Bot **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/hanzoai/bot/issues](https://github.com/hanzoai/bot/issues)
[https://github.com/hanzoai/bot/pulls](https://github.com/hanzoai/bot/pulls)
...
### Recommended way to install and set up Hanzo Bot
...
[https://github.com/hanzoai/bot/blob/main/CHANGELOG.md](https://github.com/hanzoai/bot/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### Cannot access docs.hanzo.bot (SSL error)
...
[https://github.com/hanzoai/bot/tree/main/docs](https://github.com/hanzoai/bot/tree/main/docs)
...
[https://hanzo.bot/install.ps1](https://hanzo.bot/install.ps1)
...
If you still reproduce this on latest Hanzo Bot, track/report it in:

- [Issue #30640](https://github.com/hanzoai/bot/issues/30640)
...
### How do I install Hanzo Bot on Linux
...
### How do I install Hanzo Bot on a VPS
...
### Can I ask Hanzo Bot to update itself
...
No. You can run Hanzo Bot with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like Hanzo Bot.
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in onboarding or paste it with `hanzo-bot models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in onboarding. If you want to run it on the gateway host, use `hanzo-bot models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `hanzo-bot models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Hanzo Bot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Hanzo Bot can keep replying while a provider is rate-limited.
...
Hanzo Bot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). Onboarding can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Onboarding (CLI)](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Hanzo Bot fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like Hanzo Bot. Onboarding can run the OAuth flow for you.
...
1. Enable the plugin: `hanzo-bot plugins enable google`
...
Usually no. Hanzo Bot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Hanzo Bot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Hanzo Bot can I connect it to my MacBook Pro
...
Onboarding accepts `@username` input and resolves it to a numeric ID, but Hanzo Bot authorization uses numeric IDs only.
...
### Can multiple people use one WhatsApp number with different Hanzo Bot instances
...
If you run Hanzo Bot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
(`~/.openclaw`) and workspace (`~/.hanzo/bot/workspace`) stay untouched.
...
**Hanzo Bot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Hanzo Bot on a dedicated machine
...
Hanzo Bot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Hanzo Bot in a VM and what are the requirements
...
### What is Hanzo Bot in one paragraph

Hanzo Bot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Value proposition

Hanzo Bot is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Hanzo Bot
...
### Can Hanzo Bot help with lead gen outreach ads and blogs for a SaaS
...
Hanzo Bot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Hanzo Bot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Hanzo Bot when you
...
Showcase: [https://hanzo.bot/showcase](https://hanzo.bot/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.hanzo/bot/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.hanzoai/bot.json`). Precedence is `<workspace>/skills` > `~/.hanzo/bot/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.hanzoai/bot.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.hanzo/bot/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Hanzo Bot treats as `<workspace>/skills`.
...
Browse skills at [https://skills.hanzo.bot](https://skills.hanzo.bot).
...
### Can Hanzo Bot run tasks on a schedule or continuously in the background
...
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Hanzo Bot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Hanzo Bot workspace); Hanzo Bot treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.hanzo/bot/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).

### How do I use my existing signed-in Chrome with Hanzo Bot
...
Hanzo Bot memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Hanzo Bot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Hanzo Bot auto-selects a provider when it
...
configured and present, Hanzo Bot
...
### Is all data used with Hanzo Bot saved locally
...
### How do I completely uninstall Hanzo Bot
...
`workspace` to the repo root. The Hanzo Bot repo is just source code; keep the
...
Hanzo Bot reads an optional **JSON5** config from `$BOT_CONFIG_PATH` (default: `~/.hanzoai/bot.json`):
...
Hanzo Bot enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.
...
- `default`: uses `All your chats, one Hanzo Bot.` every time.
...
**Recommended:** run `hanzo-bot configure --section web` and choose a provider.
...
### Can the Hanzo Bot browser run headless
...
### Can two Hanzo Bot instances talk to each other local VPS
...
- Restore from backup (git or a copied `~/.hanzoai/bot.json`).
...
### How does Hanzo Bot load environment variables

Hanzo Bot reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:
...
does **not** mean your env vars are missing - it just means Hanzo Bot won't load
...
### Is there a way to make a team of Hanzo Bot instances one CEO and many agents
...
### How do I completely reset Hanzo Bot but keep it installed
...
headers like `# Heading`), Hanzo Bot skips the heartbeat run to save API calls.
...
No. Hanzo Bot runs on **your own account**, so if you're in the group, Hanzo Bot can see it.
...
### Why does Hanzo Bot not reply in a group
...
Hanzo Bot's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Hanzo Bot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
4. Run `hanzo-bot onboard` and choose `Ollama`
...
- for manual switching, use `hanzo-bot models list` and `hanzo-bot models set ollama/<model>`
...
- edit `agents.defaults.model` in `~/.hanzoai/bot.json`
...
### What do Hanzo Bot, Flawd, and Krill use for models
...
Yes. Hanzo Bot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
Cooldowns apply to failing profiles (exponential backoff), so Hanzo Bot can keep responding even when a provider is rate-limited or temporarily failing.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Hanzo Bot will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Hanzo Bot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Hanzo Bot uses provider-prefixed IDs like:
...
Hanzo Bot may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `hanzo-bot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
Hanzo Bot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `hanzo-bot gateway --port <port>`.

### How do I run Hanzo Bot in remote mode client connects to a Gateway elsewhere
...
- If mismatch persists after the one retry, rotate/re-approve the paired device token:
  - `hanzo-bot devices list`
  - `hanzo-bot devices rotate --device <id> --role operator`
...
- Use `hanzo-bot --profile <name> …` per instance (auto-creates `~/.openclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `hanzo-bot --profile <name> gateway install`.

Profiles also suffix service names (`ai.hanzo.bot.<profile>`; legacy `com.openclaw.*`, `openclaw-gateway-<profile>.service`, `Hanzo Bot Gateway (<profile>)`).
...
- macOS: `$BOT_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.hanzo/bot/logs/...`; profiles use `~/.openclaw-<profile>/logs/...`)
...
### I closed my terminal on Windows how do I restart Hanzo Bot
...
- `BOT_COMMANDS_TOO_MUCH`: the Telegram menu has too many entries. Hanzo Bot already trims to the Telegram limit and retries with fewer commands, but some menu entries still need to be dropped. Reduce plugin/skill/custom commands, or disable `channels.telegram.commands.native` if you do not need the menu.
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Hanzo Bot assistant setup](/start/openclaw) and [Agent send](/tools/agent-send).
...
### Is it safe to expose Hanzo Bot to inbound DMs
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Hanzo Bot only replies to chats it receives or to explicit sends you trigger.
...
Hanzo Bot blocks **cross-provider** messaging by default. If a tool call is bound
