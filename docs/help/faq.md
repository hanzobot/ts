---
summary: "Frequently asked questions about HanzoBot setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up HanzoBot?](#whats-the-recommended-way-to-install-and-set-up-hanzo-bot)
  ...
  - [I can't access docs.hanzo-bot.ai (SSL error). What now?](#i-cant-access-docshanzo-botai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or hanzo-bot not recognized](#windows-install-says-git-not-found-or-hanzo-bot-not-recognized)
  ...
  - [How do I install HanzoBot on Linux?](#how-do-i-install-hanzo-bot-on-linux)
  - [How do I install HanzoBot on a VPS?](#how-do-i-install-hanzo-bot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask HanzoBot to update itself?](#can-i-ask-hanzo-bot-to-update-itself)
  ...
  - [If I buy a Mac mini to run HanzoBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-hanzo-bot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different HanzoBot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-hanzo-bot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run HanzoBot on a dedicated machine?](#how-important-is-it-to-run-hanzo-bot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run HanzoBot in a VM and what are the requirements](#can-i-run-hanzo-bot-in-a-vm-and-what-are-the-requirements)
- [What is HanzoBot?](#what-is-hanzo-bot)
  - [What is HanzoBot, in one paragraph?](#what-is-hanzo-bot-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for HanzoBot](#what-are-the-top-five-everyday-use-cases-for-hanzo-bot)
  - [Can HanzoBot help with lead gen outreach ads and blogs for a SaaS](#can-hanzo-bot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can HanzoBot run tasks on a schedule or continuously in the background?](#can-hanzo-bot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with HanzoBot saved locally?](#is-all-data-used-with-hanzo-bot-saved-locally)
  - [Where does HanzoBot store its data?](#where-does-hanzo-bot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall HanzoBot?](#how-do-i-completely-uninstall-hanzo-bot)
...
- [Config basics](#config-basics)
  ...
  - [Can the HanzoBot browser run headless?](#can-the-hanzo-bot-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two HanzoBot instances talk to each other (local + VPS)?](#can-two-hanzo-bot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does HanzoBot load environment variables?](#how-does-hanzo-bot-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of HanzoBot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-hanzo-bot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset HanzoBot but keep it installed?](#how-do-i-completely-reset-hanzo-bot-but-keep-it-installed)
  ...
  - [Why doesn't HanzoBot reply in a group?](#why-doesnt-hanzo-bot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do HanzoBot, Flawd, and Krill use for models?](#what-do-hanzo-bot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `hanzo-bot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-hanzo-bot-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `hanzo-bot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-hanzo-bot-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run HanzoBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-hanzo-bot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart HanzoBot?](#i-closed-my-terminal-on-windows-how-do-i-restart-hanzo-bot)
  ...
  - [ELI5: `hanzo-bot gateway restart` vs `hanzo-bot gateway`](#eli5-hanzo-bot-gateway-restart-vs-hanzo-bot-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose HanzoBot to inbound DMs?](#is-it-safe-to-expose-hanzo-bot-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/hanzo-bot/hanzo-bot-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   hanzo-bot health --json
   hanzo-bot health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://hanzo-bot.ai/install.sh | bash -s -- --install-method git
```

This installs HanzoBot **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/hanzo-bot/hanzo-bot/issues](https://github.com/hanzo-bot/hanzo-bot/issues)
[https://github.com/hanzo-bot/hanzo-bot/pulls](https://github.com/hanzo-bot/hanzo-bot/pulls)
...
- `hanzo-bot status`: quick snapshot of gateway/agent health + basic config.
- `hanzo-bot models status`: checks provider auth + model availability.
- `hanzo-bot doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `hanzo-bot status --all`, `hanzo-bot logs --follow`,
`hanzo-bot gateway status`, `hanzo-bot health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up HanzoBot

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://hanzo-bot.ai/install.sh | bash
...
```bash
git clone https://github.com/hanzo-bot/hanzo-bot.git
cd hanzo-bot
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm hanzo-bot onboard`.
...
- Retrieve it from the gateway host: `hanzo-bot config get gateway.auth.token` (or generate one: `hanzo-bot doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `hanzo-bot gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `hanzo-bot gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
[https://github.com/hanzo-bot/hanzo-bot/blob/main/CHANGELOG.md](https://github.com/hanzo-bot/hanzo-bot/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.hanzo-bot.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.hanzo-bot.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.hanzo-bot.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docshanzo-botai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/hanzo-bot/hanzo-bot/tree/main/docs](https://github.com/hanzo-bot/hanzo-bot/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://hanzo-bot.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://hanzo-bot.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://hanzo-bot.ai/install.ps1](https://hanzo-bot.ai/install.ps1)
...
```bash
curl -fsSL https://hanzo-bot.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://hanzo-bot.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://hanzo-bot.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://hanzo-bot.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```
...
**2) hanzo-bot is not recognized after install**
...
If you still reproduce this on latest HanzoBot, track/report it in:

- [Issue #30640](https://github.com/hanzo-bot/hanzo-bot/issues/30640)
...
### How do I install HanzoBot on Linux
...
### How do I install HanzoBot on a VPS
...
### Can I ask HanzoBot to update itself
...
hanzo-bot update --tag <dist-tag|version>
...
```bash
hanzo-bot update --yes --no-restart
hanzo-bot gateway restart
```
...
`hanzo-bot onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run HanzoBot with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like HanzoBot.
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `hanzo-bot models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `hanzo-bot models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `hanzo-bot models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. HanzoBot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so HanzoBot can keep replying while a provider is rate-limited.
...
HanzoBot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. HanzoBot fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like HanzoBot. The onboarding wizard can run the OAuth flow for you.
...
1. Enable the plugin: `hanzo-bot plugins enable google-gemini-cli-auth`
2. Login: `hanzo-bot models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. HanzoBot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. HanzoBot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run HanzoBot can I connect it to my MacBook Pro
...
- Use `hanzo-bot nodes status` / `hanzo-bot nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but HanzoBot authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `hanzo-bot logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different HanzoBot instances
...
If you run HanzoBot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
**HanzoBot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run HanzoBot on a dedicated machine
...
HanzoBot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run HanzoBot in a VM and what are the requirements
...
### What is HanzoBot in one paragraph

HanzoBot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

HanzoBot is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for HanzoBot
...
### Can HanzoBot help with lead gen outreach ads and blogs for a SaaS
...
HanzoBot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

HanzoBot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use HanzoBot when you
...
Showcase: [https://hanzo-bot.ai/showcase](https://hanzo-bot.ai/showcase)
...
```bash
hanzo-bot cron run <jobId> --force
...
### Can HanzoBot run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.hanzo-bot.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-hanzo-bot-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. HanzoBot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.hanzo-bot/skills`) to allow Linux:
   ...
   metadata: { "hanzo-bot": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
HanzoBot memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

HanzoBot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, HanzoBot auto-selects a provider when it
...
configured and present, HanzoBot
...
### Is all data used with HanzoBot saved locally
...
### How do I completely uninstall HanzoBot
...
`workspace` to the repo root. The HanzoBot repo is just source code; keep the
...
HanzoBot enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `hanzo-bot doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one HanzoBot.` every time.
...
key. **Recommended:** run `hanzo-bot configure --section web` to store it in
...
### Can the HanzoBot browser run headless
...
- Gateway is running: `hanzo-bot gateway status`
- Gateway health: `hanzo-bot status`
- Channel health: `hanzo-bot channels status`
...
### Can two HanzoBot instances talk to each other local VPS
...
`hanzo-bot agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
hanzo-bot agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Use `hanzo-bot config set` for small changes.
- Use `hanzo-bot configure` for interactive edits.
...
### How does HanzoBot load environment variables
...
`hanzo-bot models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means HanzoBot won't load
...
### Is there a way to make a team of HanzoBot instances one CEO and many agents
...
### How do I completely reset HanzoBot but keep it installed
...
```bash
hanzo-bot reset --scope full --yes --non-interactive
```
...
headers like `# Heading`), HanzoBot skips the heartbeat run to save API calls.
...
No. HanzoBot runs on **your own account**, so if you're in the group, HanzoBot can see it.
...
```bash
hanzo-bot directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't HanzoBot reply in a group
...
- Use `hanzo-bot doctor` to spot stray workspaces and profile mismatches.
...
HanzoBot's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, HanzoBot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
### What do HanzoBot, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `hanzo-bot models status`.
...
Yes. HanzoBot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run `hanzo-bot agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so HanzoBot can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Sanity-check model/auth status**
  - Use `hanzo-bot models status` to see configured models and whether providers are authenticated.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), HanzoBot will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: HanzoBot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
HanzoBot uses provider-prefixed IDs like:
...
HanzoBot may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `hanzo-bot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
hanzo-bot models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
hanzo-bot models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

HanzoBot supports both:
...
### Why does hanzo-bot gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `hanzo-bot gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does hanzo-bot gateway status show Config cli and Config service different
...
HanzoBot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `hanzo-bot gateway --port <port>`.

### How do I run HanzoBot in remote mode client connects to a Gateway elsewhere
...
- `hanzo-bot gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `hanzo-bot.control.settings.v1`.

Fix:

- Fastest: `hanzo-bot dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `hanzo-bot doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `BOT_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `hanzo-bot status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
Profiles also suffix service names (`ai.hanzo.bot.<profile>`; legacy `com.hanzo-bot.*`, `hanzo-bot-gateway-<profile>.service`, `HanzoBot Gateway (<profile>)`).
...
```
hanzo-bot tui --url ws://<host>:18789 --token <token>
```
...
If you run the gateway manually, `hanzo-bot gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart HanzoBot
...
1. Is the Gateway running? `hanzo-bot gateway status`
2. Is the Gateway healthy? `hanzo-bot status`
3. Does the UI have the right token? `hanzo-bot dashboard`
...
```bash
hanzo-bot channels status
hanzo-bot channels logs --channel telegram
```
...
### ELI5 hanzo-bot gateway restart vs hanzo-bot gateway

- `hanzo-bot gateway restart`: restarts the **background service** (launchd/systemd).
- `hanzo-bot gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `hanzo-bot gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [HanzoBot assistant setup](/start/hanzo-bot) and [Agent send](/tools/agent-send).

CLI sending:

```bash
hanzo-bot message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose HanzoBot to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `hanzo-bot pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `hanzo-bot pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `hanzo-bot doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. HanzoBot only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
hanzo-bot pairing approve whatsapp <code>
```

List pending requests:

```bash
hanzo-bot pairing list whatsapp
```
...
HanzoBot blocks **cross-provider** messaging by default. If a tool call is bound
