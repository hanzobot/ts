...
Hanzo Bot also injects context markers into spawned child processes:
...
- `COLORFGBG`: if your terminal exports it, Hanzo Bot uses the background color hint to auto-pick the TUI palette.
...
Hanzo Bot supports two env-driven patterns:
