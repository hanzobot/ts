---
summary: "Use Venice AI privacy-focused models in HanzoBot"
read_when:
  - You want privacy-focused inference in HanzoBot
...
```bash
hanzo-bot agent --model venice/llama-3.3-70b --message "Hello, are you working?"
```

## Model Selection

After setup, HanzoBot shows all available Venice models. Pick based on your needs:
...
HanzoBot automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
...
hanzo-bot agent --model venice/llama-3.3-70b --message "Quick health check"

# Use Claude via Venice (anonymized)
hanzo-bot agent --model venice/claude-opus-45 --message "Summarize this task"

# Use uncensored model
hanzo-bot agent --model venice/venice-uncensored --message "Draft options"

# Use vision model with image
hanzo-bot agent --model venice/qwen3-vl-235b-a22b --message "Review attached image"

# Use coding model
hanzo-bot agent --model venice/qwen3-coder-480b-a35b-instruct --message "Refactor this function"
```
