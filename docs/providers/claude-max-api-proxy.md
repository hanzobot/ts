...
You can point HanzoBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or HanzoBot
...
- [Anthropic provider](/providers/anthropic) - Native HanzoBot integration with Claude setup-token or API keys
