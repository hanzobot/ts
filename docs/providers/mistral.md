---
summary: "Use Mistral models and Voxtral transcription with Hanzo Bot"
read_when:
  - You want to use Mistral models in Hanzo Bot
...
Hanzo Bot supports Mistral for both text/image model routing (`mistral/...`) and
