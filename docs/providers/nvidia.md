---
summary: "Use NVIDIA's OpenAI-compatible API in HanzoBot"
read_when:
  - You want to use NVIDIA models in HanzoBot
...
hanzo-bot onboard --auth-choice skip
hanzo-bot models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
