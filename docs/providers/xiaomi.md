---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with HanzoBot"
read_when:
  - You want Xiaomi MiMo models in HanzoBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). HanzoBot uses
