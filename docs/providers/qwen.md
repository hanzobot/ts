---
summary: "Use Qwen OAuth (free tier) in HanzoBot"
read_when:
  - You want to use Qwen with HanzoBot
...
If you already logged in with the Qwen Code CLI, HanzoBot will sync credentials
