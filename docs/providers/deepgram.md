...
Deepgram is a speech-to-text API. In Hanzo Bot it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Hanzo Bot uploads the audio file to Deepgram and injects the transcript
