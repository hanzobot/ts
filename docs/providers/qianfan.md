---
summary: "Use Qianfan's unified API to access many models in HanzoBot"
read_when:
...
3. HanzoBot installed on your system
...
4. Copy the API key for use with HanzoBot

## CLI setup

```bash
hanzo-bot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [HanzoBot Configuration](/gateway/configuration)
