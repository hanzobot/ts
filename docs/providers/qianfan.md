---
summary: "Use Qianfan's unified API to access many models in Hanzo Bot"
read_when:
...
3. Hanzo Bot installed on your system
...
4. Copy the API key for use with Hanzo Bot
...
- [Hanzo Bot Configuration](/gateway/configuration)
