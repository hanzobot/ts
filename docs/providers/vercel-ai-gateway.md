...
read_when:
  - You want to use Vercel AI Gateway with Hanzo Bot
...
- Hanzo Bot auto-discovers the Gateway `/v1/models` catalog, so `/models vercel-ai-gateway`
...
Hanzo Bot accepts Vercel Claude shorthand model refs and normalizes them at
runtime:
