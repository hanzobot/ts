...
read_when:
  - You want to use Vercel AI Gateway with HanzoBot
...
```bash
hanzo-bot onboard --auth-choice ai-gateway-api-key
```
...
HanzoBot accepts Vercel Claude shorthand model refs and normalizes them at
runtime:
