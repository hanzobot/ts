---
summary: "Use Synthetic's Anthropic-compatible API in Hanzo Bot"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Hanzo Bot registers it as the
...
Note: Hanzo Bot's Anthropic client appends `/v1` to the base URL, so use
