---
summary: "Overview of HanzoBot onboarding options and flows"
read_when:
...
HanzoBot supports multiple onboarding paths depending on where the Gateway runs
...
Use the HanzoBot app when you want a fully guided setup on macOS. Docs:
