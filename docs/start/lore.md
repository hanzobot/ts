---
summary: "Backstory and lore of Hanzo Bot for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Hanzo Bot Lore"
---

# The Lore of Hanzo Bot 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Hanzo Bot**.
...
The **Moltiverse** is the community and ecosystem around Hanzo Bot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Hanzo Bot): _happily runs `find ~` and shares entire directory structure in group chat_
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Hanzo Bot" to promote pump-and-dump tokens.
...
**The Great Hanzo Bot Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/hanzoai/bot` ✅
- X handle `@openclaw` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.hanzo.bot`
