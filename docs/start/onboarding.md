---
summary: "First-run onboarding flow for HanzoBot (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give HanzoBot">
...
<Step title="CLI">
  ...
  The app can install the global `hanzo-bot` CLI via npm/pnpm so terminal
