...
Add a `groupChat` block to `~/.hanzoai/bot.json` so display-name pings work even when WhatsApp strips the visual `@` in the text body:
...
1. Add your WhatsApp account (the one running Hanzo Bot) to the group.
