...
read_when:
  - You want Hanzo Bot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Hanzo Bot to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- Onboarding (`hanzo-bot onboard`) and `hanzo-bot channels add` list optional channel plugins.
