...
read_when:
  - You want HanzoBot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables HanzoBot to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`hanzo-bot onboard`) and `hanzo-bot channels add` list optional channel plugins.
...
```bash
hanzo-bot plugins install @hanzo/bot-nostr
```

Use a local checkout (dev workflows):

```bash
hanzo-bot plugins install --link <path-to-hanzo-bot>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "hanzo-bot",
        "displayName": "HanzoBot",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "hanzo-bot@example.com",
        "lud16": "hanzo-bot@example.com"
      }
    }
  }
}
