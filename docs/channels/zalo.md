...
- Install via CLI: `hanzo-bot plugins install @hanzo/bot-zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `hanzo-bot plugins install ./extensions/zalo`
   - From npm (if published): `hanzo-bot plugins install @hanzo/bot-zalo`
...
This page reflects current Hanzo Bot behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `hanzo-bot pairing list zalo`
  - `hanzo-bot pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Hanzo Bot.
...
- Example: `hanzo-bot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `hanzo-bot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `hanzo-bot logs --follow`
