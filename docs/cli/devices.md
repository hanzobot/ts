...
### `hanzo-bot devices remove <deviceId>`

Remove one paired device entry.

```
hanzo-bot devices remove <deviceId>
hanzo-bot devices remove <deviceId> --json
```

### `hanzo-bot devices clear --yes [--pending]`

Clear paired devices in bulk.

```
hanzo-bot devices clear --yes
hanzo-bot devices clear --yes --pending
hanzo-bot devices clear --yes --pending --json
```

### `hanzo-bot devices approve [requestId] [--latest]`

Approve a pending device pairing request. If `requestId` is omitted, HanzoBot
automatically approves the most recent pending request.

```
hanzo-bot devices approve
