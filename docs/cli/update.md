...
- `--tag <dist-tag|version|spec>`: override the package target for this update only. For package installs, `main` maps to `github:hanzoai/bot#main`.
...
- `dev` → ensures a git checkout (default: `~/openclaw`, override with `BOT_GIT_DIR`),
