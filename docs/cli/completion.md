...
read_when:
  ...
  - You need to cache completion scripts under Hanzo Bot state
title: "completion"
---
...
- `--install` writes a small "Hanzo Bot Completion" block into your shell profile and points it at the cached script.
