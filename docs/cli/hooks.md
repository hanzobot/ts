...
Details:
  ...
  Path: /path/to/hanzo-bot/hooks/bundled/session-memory/HOOK.md
  Handler: /path/to/hanzo-bot/hooks/bundled/session-memory/handler.ts
  Homepage: https://docs.hanzo-bot.ai/automation/hooks#session-memory
  Events: command:new
...
hanzo-bot hooks install <npm-spec> --pin
```
...
# NPM package
hanzo-bot hooks install @hanzo/bot-my-hook-pack
...
HanzoBot prints a warning and asks for confirmation before proceeding. Use
