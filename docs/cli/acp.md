...
Run the [Agent Client Protocol (ACP)](https://agentclientprotocol.com/) bridge that talks to a HanzoBot Gateway.
...
it to drive a HanzoBot Gateway session.
...
- `--server <command>`: ACP server command (default: `hanzo-bot`).
