...
summary: "Architecture of Hanzo Bot's embedded Pi agent integration and session lifecycle"
read_when:
  - Understanding Pi SDK integration design in Hanzo Bot
...
Image injection is prompt-local: Hanzo Bot loads image refs from the current prompt and
